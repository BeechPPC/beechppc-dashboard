---
name: csv-analyzer
description: Analyzes CSV files (including Google Ads reports, financial data, sales data) and generates comprehensive statistics, correlations, and visualizations. Use when user provides a CSV file, asks to analyze tabular data, or wants insights from data exports.
allowed-tools: Read, Write, Bash, Glob
---

# CSV Analyzer

This Skill analyzes CSV files and provides comprehensive summaries with statistical insights and visualizations. Particularly useful for Google Ads reports, financial data, and business metrics.
...
3. **Determine relevant analyses** based on what's actually in the data:
   - **Google Ads data** (campaigns, ad groups, metrics, costs): Performance analysis, cost trends, conversion metrics
...
**Example adaptations:**
- Google Ads exports → Focus on campaign performance, cost efficiency, conversion patterns, ROI metrics
...
> "Here's an ad group report from Google Ads. Analyze it."

> "Analyze this campaign performance CSV and show me trends."

> "What insights can you find in this Google Ads export?"
